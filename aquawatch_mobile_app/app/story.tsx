    ...
    return (
        <>
            ...
            <ScrollView className="dark:bg-darkBackground bg-lightBackground p-5">
                {/* Title */}
                <Text className="dark:text-darkText mb-8 text-center text-2xl font-bold text-blue-800">
                ...
                <Text className="dark:text-darkText mb-4 text-base text-gray-700 ">
                ...
                {/* Closing Statement */}
                <Text className="dark:text-darkText mt-5 text-center text-lg italic text-gray-600 ">
                    <Text className="font-bold">
                        "All of us at Blue CoLab look forward to seeing you on the team."
                    </Text>
                </Text>
                <Text className="dark:text-darkText mb-20 pb-10 text-center text-lg italic text-gray-600 ">

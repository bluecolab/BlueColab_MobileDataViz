...
export default function VersionHistory() {
    ...
    return (
        <>
            ...
            />
            <ScrollView className="dark:bg-darkBackground bg-lightBackground p-default">
                {/* Version 0.9 */}
                <View className="dark:bg-darkCardBackground m-default rounded-3xl bg-white p-default">

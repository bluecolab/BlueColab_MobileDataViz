  ...
  return (
    <ScrollView className="bg-gray-100 p-5 dark:bg-gray-900">
      ...
      <Text className="mb-4 text-base text-gray-700 dark:text-white ">
        ...
        water before you drink it, swim in it, fish it, or even swamp your
        canoe.
      </Text>
      ...
      <Text className="mb-4 text-base text-gray-700 dark:text-white ">
        In <Text className="font-bold">Milwaukee (1993)</Text>, 400,000
        residents were made ill and 100 died due to drinking water contaminated
        with cryptosporidium. Residents in{' '}
        <Text className="font-bold">Hoosick Falls</Text> and{' '}

    ...
    <ScrollView className="bg-defaultbackground p-default dark:bg-defaultdarkbackground">
      ...
      <View className="m-default rounded-3xl  bg-white p-default dark:bg-gray-700">
        ...
        <Text className="mt-2 text-gray-700 dark:text-gray-300">
          The first version of the AquaWatch Mobile App (aka Choate Visual,
          Turbidity App during development). Developed by Blue Jelly for CS 389
          (Software Engineering) at Pace University. The team developed the
          foundation for the current app, with the following features:
        </Text>
        <View className="mt-4">
      ...
      <View className="m-default rounded-3xl  bg-white p-default dark:bg-gray-700">
        ...
        />
        <Text className="mt-2 text-gray-700 dark:text-gray-300">
          This update revamped the UI, mainly introducing new card designs and a
          new tab navigation menu. We also switched from R to Python for the
          backend - for maintainability. This was also the first version of the
          app to become available to testers on the Google Play Store.
        </Text>
        <View className="mt-4">
          <Text className="font-semibold text-gray-800 dark:text-gray-200">
            Changes:
      ...
      <View className="m-default rounded-3xl  bg-white p-default dark:bg-gray-700">
        ...
        />
        <Text className="mt-2 text-gray-700 dark:text-gray-300">
          Our previous versions of the app focused on having a working demo,
          "just make it work" thinking. However, we want to be an example of
          sustainability in a water quality app.
        </Text>
        <Text className="mt-2 text-gray-700 dark:text-gray-300">

  ...
  return (
    <ScrollView className="bg-defaultbackground dark:bg-defaultdarkbackground">
      ...
      <View className="m-default rounded-3xl  bg-white p-default tracking-tight dark:bg-gray-700">
        ...
        <Text className="text-lg text-black dark:text-white">
          Finally we would take a moment to thank all of supportive teams and
          testers that worked along side us.
        </Text>
      </View>
      ...
      <View className="m-default rounded-3xl  bg-white p-default tracking-tight dark:bg-gray-700">
        ...
        <Item
          ...
          label="Bottom Tabs"
          link="https://github.com/react-navigation/bottom-tabs"
          team={[]}
          isLinkedin={false}
        />
        <Item
          ...
          link="https://github.com/react-navigation/native"
          team={[]}
          isLinkedin={false}
        />
        <Item
        ...
        <Item
          ...
          link="https://github.com/expo/expo/tree/main/packages/expo-file-system"
          team={[]}
          isLinkedin={false}
        />
        <Item
        ...
        />
        <Item
          name="react-native-navigation-bar"
          label="React Native Navigation Bar"
          link="https://github.com/kwankwan/react-native-navigation-bar"
          team={[]}
          isLinkedin={false}
        />
        <Item
          name="react-native-orientation-locker"
          label="React Native Orientation Locker"
          link="https://github.com/wonday/react-native-orientation-locker"
          team={[]}
          isLinkedin={false}
        />
        <Item

...
const averageSensors = (data) =>
    data.reduce((acc, { Cond, DOpct, Sal, Temp, Turb, pH }) => {
                ...
                <View className="z-10 self-center">
                    <View className="h-[250]">
                        ...
                        <Animated.View
                            ...
                            <View className="elevation-[5] flex-1 items-center justify-center  rounded-3xl bg-white p-default dark:bg-gray-700 ">
                                <VictoryChart width={size} height={size}>
                                    <VictoryAxis
                                        style={{ axis: { opacity: 0 }, tickLabels: { opacity: 0 } }}
                                    />
                                    <VictoryAxis
                                        dependentAxis
                                        style={{ axis: { opacity: 0 }, tickLabels: { opacity: 0 } }}
                        ...
                        <Animated.View
                            ...
                            <ScrollView className="h-full rounded-3xl bg-white p-4 dark:bg-gray-700">
                                ...
                                <Text className="text-md dark:text-gray-300">
                                    WQI - water quality index - is a score that expresses the
                                    overall quality of water. It serves as a single, comprehensive
                                    indicator of the quality of water. The score ranges from 0 to
                                    100.
                                </Text>
                                ...
                                <Text className="text-md dark:text-gray-300">
                                    The WQI for Choate Pond is calculated based on temperature,
                                    dissolved oxygen, pH, turbidity, and salinity. We then multiply
                                    each parameter by an assigned weight. Finally the product of
                                    each calculation is summed.
                                </Text>

        ...
        <>
            ...
            <ScrollView className="bg-defaultbackground dark:bg-defaultdarkbackground">
                ...
                <View className="m-default rounded-3xl  bg-white dark:bg-gray-700 p-default tracking-tight">
                    ...
                    <Item name="@expo/vector-icons" label="Expo Vector Icons" link="https://github.com/expo/vector-icons" team={[]} isLinkedin={false} />
                    <Item name="@react-native-async-storage/async-storage" label="Async Storage" link="https://github.com/react-native-async-storage/async-storage" team={[]} isLinkedin={false} />
                    <Item name="@react-navigation/native" label="React Navigation Native" link="https://github.com/react-navigation/react-navigation" team={[]} isLinkedin={false} />
                    <Item name="@shopify/react-native-skia" label="React Native Skia" link="https://github.com/Shopify/react-native-skia" team={[]} isLinkedin={false} />
                    ...
                    <Item name="expo-constants" label="Expo Constants" link="https://github.com/expo/expo/tree/main/packages/expo-constants" team={[]} isLinkedin={false} />
                    ...
                    <Item name="expo-linking" label="Expo Linking" link="https://github.com/expo/expo/tree/main/packages/expo-linking" team={[]} isLinkedin={false} />
                    ...
                    <Item name="expo-router" label="Expo Router" link="https://github.com/expo/router" team={[]} isLinkedin={false} />
                    <Item name="expo-status-bar" label="Expo Status Bar" link="https://github.com/expo/expo/tree/main/packages/expo-status-bar" team={[]} isLinkedin={false} />
                    <Item name="expo-system-ui" label="Expo System UI" link="https://github.com/expo/expo/tree/main/packages/expo-system-ui" team={[]} isLinkedin={false} />
                    <Item name="expo-web-browser" label="Expo Web Browser" link="https://github.com/expo/expo/tree/main/packages/expo-web-browser" team={[]} isLinkedin={false} />
                    <Item name="luxon" label="Luxon" link="https://github.com/moment/luxon" team={[]} isLinkedin={false} />
                    ...
                    <Item name="react-dom" label="React DOM" link="https://github.com/facebook/react" team={[]} isLinkedin={false} />
                    ...
                    <Item name="react-native-gifted-charts" label="Gifted Charts" link="https://github.com/Abhinandan-Kushwaha/react-native-gifted-charts" team={[]} isLinkedin={false} />
                    ...
                    <Item name="react-native-reanimated-carousel" label="Reanimated Carousel" link="https://github.com/dohoons/react-native-reanimated-carousel" team={[]} isLinkedin={false} />
                    <Item name="react-native-safe-area-context" label="Safe Area Context" link="https://github.com/th3rdwave/react-native-safe-area-context" team={[]} isLinkedin={false} />
                    ...
                    <Item name="react-native-web" label="React Native Web" link="https://github.com/necolas/react-native-web" team={[]} isLinkedin={false} />
